...
% the hierarchy is guarded by a mutex until the re-computation is complete.
...
% When an overlap is detected, the levels are checked to ensure that the overlap is topological and not a false positive due to the order in which intervals are assigned. 
