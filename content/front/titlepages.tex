...
\begin{titlepage}
	...
	\begin{flushleft}
		...
		\jurymember{David}{Bomberg}{Professeur}{Université de Rennes }{Rapporteur}
		\jurymember{Pascal}{Felber}{Professeur}{Université de Neuchâtel }{Rapporteur}
		\jurymember{Esther}{Pacitti}{Professeure}{Université de Montpellier 2}{Examinatrice}
		...
		\jurymember{Marc}{Shapiro}{Directeur de Recherche Émérite}{INRIA, Sorbonne Université, LIP6}{Directeur de thèse}
		\jurymember{Mesaac}{Makpangou}{Chargé de Recherche [HDR]}{INRIA}{Directeur de thèse}
		\jurymember{Julien}{Sopena}{Maître de Conférences}{Sorbonne Université, LIP6}{Encadrant}
		\jurymember{Swan}{Dubois}{Maître de Conférences}{Sorbonne Université, LIP6}{Encadrant}
